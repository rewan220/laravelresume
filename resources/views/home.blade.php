  ...
  <nav class="navbar-expand-md navbar fixed-top" id="navbar">
    ...
    <div class="collapse navbar-collapse order-1 order-lg-0" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="{{route('mywork')}}">My Works</a></li>
        <li class="nav-item"><a class="nav-link" href="{{route('contact.index')}}">Contact</a></li>
      </ul>
    </div>
  </nav>
  <!-- Home-->
  <section class="home-area element-cover-bg" id="home" style="background-image:url(img/rewan.jpg)">
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center">
        <div class="col-12 col-lg-8 home-content text-center">
          <h1 class="home-name">Rewan <span>Youssef</span></h1>
    ...
    <div class="fixed-wrapper">
      ...
      <div class="fixed-block block-right">
        <ul class="list-unstyled social-icons">
          <li><a href="https://www.facebook.com/rewanqamishlo"><i class="icon ion-logo-facebook"></i></a></li>
          <li><a href="https://www.youtube.com/channel/UCt3FVc8vd6ohpf9uTjIRitA?view_as=subscriber"><i class="icon ion-logo-youtube"></i></a></li>
          <li><a href="https://www.instagram.com/rewan_samir_youssef"><i class="icon ion-logo-instagram"></i></a></li>
          <li><a href="https://github.com/rewan220"><i class="icon ion-logo-github"></i></a></li>
          ...
          <div class="lightbox-content">
            ...
            <div class="info-section single-section">
              <div class="row align-items-center">
                <!-- Picture part-->
                <div class="col-12 col-lg-5 info-img"><img class="img-fluid img-thumbnail" src="img/rewan_about.jpg" alt="About Picture"></div>
                <!-- Content part-->
                <div class="col-12 col-lg-7 info-content">
                  <div class="content-block">
                    <h2 class="content-subtitle">Who am i?</h2>
                    <h6 class="content-title">I'm Rewan Youssef, a Full Stack Web Developer and Programmer</h6>
                    <div class="content-description">
                      <p>I am a freelancer, love coding, I help convert a vision and an idea into meaningful and useful products. Having a sharp eye for product evolution helps me prioritize tasks, iterate fast and deliver faster,I don't follow Trends I make them</p>
                    </div>
                    <address class="content-info">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-6 single-info"><span>Email:</span>
                          <p><a href="http/mailto:youssefrewan15@gmail.com">youssefrewan15@gmail.com</a></p>
                        </div>
                      </div>
                      <div class="row">
                    ...
                    <div class="d-block d-sm-flex align-items-center"><a class="btn content-download button-main button-scheme" href="rewan youssef.pdf" role="button">Download CV</a>
                      <ul class="list-unstyled list-inline content-follow">
                        <li class="list-inline-item"><a href="https://www.instagram.com/rewan_samir_youssef"><i class="icon ion-logo-instagram"></i></a></li>
                        <li class="list-inline-item"><a href="https://www.youtube.com/channel/UCt3FVc8vd6ohpf9uTjIRitA?view_as=subscriber"><i class="icon ion-logo-youtube"></i></a></li>
                        <li class="list-inline-item"><a href="https://github.com/rewan220"><i class="icon ion-logo-github"></i></a></li>
                        <li class="list-inline-item"><a href="https://www.facebook.com/rewanqamishlo"><i class="icon ion-logo-facebook"></i></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="section-heading">
                    <p class="section-description">Tools I can't live without</p>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><!--<i class="icon service-icon ion-logo-wordpress"></i>-->
                    ...
                    <p class="service-description">
                      HTML<br/>
                      CSS(Bootstrap, W3.CSS)<br/>
                      JS(J-Query,AngularJS,Vue.js, React)<br/>
                      PHP(laravel.8-Symfony.4)<br/></p>
                  </div>
                </div>
                <!-- Single service-->
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><!--<i class="icon service-icon ion-logo-css3"></i>-->
                    <h6 class="service-title">Programming Languages</h6>
                    <p class="service-description">
                      c++<br/>
                      C#(.NET)<br/>
                      JAVA(AndroidSDK)</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><!--<i class="icon service-icon ion-logo-ionic"></i>-->
                    <h6 class="service-title">Data Base</h6>
                    <p class="service-description">
                      SQL<br/>
                      MYsql<br/>
                      Oracle</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><!--<i class="icon service-icon ion-md-images"></i>-->
                    <h6 class="service-title">Operating System</h6>
                    <p class="service-description">
                      Window(8.1-10)<br/>
                      Linux(CentOS.7)<br/>
                      Android</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><!--<i class="icon service-icon ion-md-move"></i>-->
                    <h6 class="service-title">Development Tools</h6>
                    <p class="service-description">
                      Visual Studio<br/>
                      PhpStorm<br/>
                      Brackets<br/>
